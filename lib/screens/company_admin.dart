...
import 'package:client_nfc_mobile_app/utils/loading.dart';
...
class CompanyAdmin extends StatefulWidget {
  const CompanyAdmin({super.key});

  @override
  State<CompanyAdmin> createState() => _CompanyAdminState();
}
    ...
    return Scaffold(
      body: Builder(builder: (context) {
        ...
        if (pro.isLoading || gro.isLoading) {
          Future.microtask(() => MyLoader.showLoadingDialog(context));
        }
